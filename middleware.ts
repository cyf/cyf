...
import { cacheTokenKey, cacheLngKey, domain, basePath } from "./constants";
...
export const config = {
  // matcher: '/:lng*'
  matcher: [
    "/((?!backend|_next/static|_next/image|images|videos|assets|favicon.ico|logo.jpg|ads.txt|sitemap.xml|.well-known|rss.xml|sw.js).*)",
    { source: "/" },
  ],
};
